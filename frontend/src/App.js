...
function App() {
  return (
    ...
    <Router>
      ...
      <Route
        exact
        path="/addConferenceDetails"
        component={AddConferenceDetails}
      />
      <Route exact path="/edit/:id" component={EditConferenceDetails} />
      <Route
        exact
        path="/getConferenceDetails"
        component={GetConferenceDetails}
      />
      <Route exact path="/" component={Home} />
      <Route
        exact
        path="/adminConferenceDetails"
        component={AdminConferenceDetails}
      />
